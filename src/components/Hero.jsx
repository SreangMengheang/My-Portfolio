...
const Hero = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto pu-8 bg-black">
      ...
      <div className="col-span-2 px-5 my-auto">
        <h1 className="text-white text-4xl sm:text-5xl lg:text-8xl font-extrabold">
          ...
          <br />
          <TypeAnimation
            sequence={["Frontend Dev", 1000, "Website Dev", 1000]}
            wrapper="span"
            speed={50}
            repeat={Infinity}
          />
        ...
        <p className="text-white sm:text-lg my-6 lg:text-xl">
          My name is Sreang Mengheang and I am studying website development.
        </p>
        <div className="my-8">
          <a
            href="/"
